...
// session_start();//se inicia sesion para llamar a las variables $_SESSION creadas en otros archivos, o para crearlas si es necesario
	...
	$_SESSION["Puntos"]= $Puntaje;//Se crea la sesion, necesaria en respuesta.php
	//echo "Puntos: " . $Puntaje;
		if ($Puntaje==0){
				include("preguntaBiblia_Jeremias_01.php");
		}
		else if ($Puntaje==1){
				include("preguntaBiblia_Jeremias_02.php");
		}
		else if ($Puntaje==2){
				include("preguntaBiblia_Jeremias_03.php");
		}
		else if ($Puntaje==3){
				include("preguntaBiblia_Jeremias_04.php");
		}
		else if ($Puntaje==4){
				include("preguntaBiblia_Jeremias_05.php");
		}
		else if ($Puntaje==5){
				include("preguntaBiblia_Jeremias_06.php");
		}
		else if ($Puntaje==6){
				include("preguntaBiblia_Jeremias_07.php");
		}
		else if ($Puntaje==7){
				include("preguntaBiblia_Jeremias_08.php");
		}
		else if ($Puntaje==8){
				include("preguntaBiblia_Jeremias_09.php");
		}
		else if ($Puntaje==9){
				include("preguntaBiblia_Jeremias_10.php");
		}
		else if ($Puntaje==10){
