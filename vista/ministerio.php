	...
	<html lang="es">
		...
		<body>
			...
			<div class="contenedor_24" onclick="ocultarMenu()">
				...
				<p class="Inicio_3">Dentro de las dinámica que se plantean tenemos:</p>
				
				<ul>
					<li>Test Reavivados: 
						<P>consiste en un sencillo test de cinco preguntas sobre el capítulo bíblico estudiado el día de hoy &nbsp<b>"<?php echo $CapituloHoy;?>"</b>, al finalizarlo se le notifica su resultado en un reporte general de su actuación, y su posicionamiento con respecto a todos los miembros de la comunidad de Reavivados.</p> 
					...
					<li>Test de libro biblico:
						<P>Es un test de 10 preguntas por cada libro de la biblia.</p>
					</li>
					<li>Estudios biblicos:
						<P>Se presentan lecciones del texto biblico y se realiza un test por cada lección.</p>
					</li>
				</ul>
			</div>
			<footer>
