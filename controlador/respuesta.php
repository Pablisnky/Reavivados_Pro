...
include("../modulos/muestraError.php");
	...
	$Puntaje= $_SESSION["Puntos"];//creada en posicionXxxxxxx.php (Xxxxx = test en curso)
	// echo "ID_Participante= " . $Participante . "<br>";
	// echo "Tema= " . $Tema . "<br>";
	//  echo "Pregunta= " . $Pregunta . "<br>";
	//  echo "Codigo prueba= " . $CodigoPrueba . "<br>";

	$Aleatorio_1= $_SESSION["Preguna_1"];//Sesion creada en posicionXxxxxxx.php (Xxxxx = test en curso)
	$Aleatorio_2= $_SESSION["Preguna_2"];//Sesion creada en posicionXxxxxxx.php (Xxxxx = test en curso)
	$Aleatorio_3= $_SESSION["Preguna_3"];//Sesion creada en posicionXxxxxxx.php (Xxxxx = test en curso)
	$Aleatorio_4= $_SESSION["Preguna_4"];//Sesion creada en posicionXxxxxxx.php (Xxxxx = test en curso)
	$Aleatorio_5= $_SESSION["Preguna_5"];//Sesion creada en posicionXxxxxxx.php (Xxxxx = test en curso)
