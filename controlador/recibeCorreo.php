...
//     unset($_SESSION['verifica']);//se borra la $_SESSION verifica.
    ...
    $Insertar_1= "INSERT INTO codigo_recuperacion(correo, codigoAleatorio, Fecha_solicitud)VALUES('$Correo','$Aleatorio',NOW())";
    mysqli_query($conexion, $Insertar_1) or DIE (mysqli_error($conexion) . 'Falló primera conexión a la base de datos');
