<?php   
    //Archivo incluido en entrada.php
  ...
  // --------------------------------------------------------------------------------------------
    ...
    // echo "Hora PHP de abre pregunta" . $HoraServidorPHP . "<br>";
  ...
  // Si la pregunta no ha sido respondida
    if($VerificarPregunta == 0){ 
        ...
        $insertar= "INSERT INTO respuestas(ID_Pregunta, ID_Participante, ID_PP, Tema, Hora_Pregunta,Hora_Respuesta, HoraMaximo) VALUES('$Pregunta', '$Participante', '$CodigoPrueba', '$Tema', '$HoraServidorPHP', NULL, '$PHPlocal')";
        mysqli_query($conexion,$insertar) or DIE (mysqli_error($conexion) . 'Falló conexión a la base de datos (Temp_2)');    
    }
    else{
